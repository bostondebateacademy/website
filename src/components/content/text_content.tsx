    ...
    return (
        <div>
            <p className="p-bio">
                ...
                State Champions, 5th Place in High School Nationals, and 1st Place in Middle School. From Indiana
                to New Jersey to Massachusetts, Ben has mastered the recipe for self-improvement, critical thinking,
                and finding every student’s inner voice.
            </p>
        </div>
    );
}
    ...
    return (
        <div>
            <p className="p-bio">
                ...
                tournament, such as Bronx Science and Yale. Max has crafted curriculum for the world’s most
                elite debate programs, including Harvard University, Stuyvesant High School, and Bergen
                Debate, consistently producing State and National Champions.
            </p>
        </div>
    );
}